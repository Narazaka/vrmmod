package net.narazaka.vrmmod.physics

import net.narazaka.vrmmod.vrm.ColliderShape
import net.narazaka.vrmmod.vrm.VrmSkeleton
import net.narazaka.vrmmod.vrm.VrmSpringBone
...
class SpringBoneSimulator(
    ...
    private fun computeTailPos(
        jointIdx: Int,
        joints: List<net.narazaka.vrmmod.vrm.SpringJoint>,
        worldMatrices: List<Matrix4f>,
        headPos: Vector3f,
        nodeIndex: Int,
    ): Vector3f {
